 ...
 */
class Localite extends \GST\ImmobilierBundle\Entity\Localite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Localite' . "\0" . 'id', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Localite' . "\0" . 'libelleloca', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Localite' . "\0" . 'biens', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Localite' . "\0" . 'bienpros'];
        }
