 ...
 */
class Client extends \GST\ImmobilierBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Client' . "\0" . 'numeropiece', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Client' . "\0" . 'nomclient', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Client' . "\0" . 'telclient', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Client' . "\0" . 'adresseclient', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Client' . "\0" . 'emailclient', '' . "\0" . 'GST\\ImmobilierBundle\\Entity\\Client' . "\0" . 'password'];
        }
